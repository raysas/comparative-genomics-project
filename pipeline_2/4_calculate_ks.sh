...
input_dir="/mnt/d/documents/documents/comparative-genomics-project/comparative-genomics-project/output/ks/test/aligned_pairs"
output_dir="/mnt/d/documents/documents/comparative-genomics-project/comparative-genomics-project/output/ks/test/ks_results"
mkdir -p "$output_dir"
